...
\section{Surface Habitability Mapping}

This study asks a spatial question that the other four do not: \emph{where} is Titan's surface most likely
to be habitable, and how has that pattern changed through time? Working at the outermost layer of
Figure~\ref{fig:crosssection}, the analysis casts this as Bayesian inference, computing a posterior habitability
...
future ($+5.9$\,Gya), turning a static map into a trajectory. In the present epoch, the north-polar lake shores
...
proxy for the organic--water-ice contact terrain it will sample \citep{Lorenz2021Landing}. The global median
$P(H)$ climbs from $0.27$ at the LHB to $0.32$ at present, holds steady through the near-future plateau, then, after a $\sim$1\,Gyr solvent-free minimum around $+5$\,Gya (once the hydrocarbon
seas evaporate), rises to its maximum of $0.53$ under a red-giant water--ammonia ocean. Habitability is
therefore episodic in time.
...
studies: the top-ranked sites are polar lake shores, where present-day solvent and organics coincide, whereas
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{images/habitability_map.png}
