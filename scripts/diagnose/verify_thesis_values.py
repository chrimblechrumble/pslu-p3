...
weights = [0.25, 0.20, 0.20, 0.15, 0.08, 0.06, 0.04, 0.02]
h, w = post.shape
...
for feat in features:
    arr = ds[feat].values
    selk_val = sample(arr, 199.0, 7.0)
    glob_med = np.median(arr)
...
print("=" * 70)
for feat in features:
    val = sample(ds[feat].values, 210.0, 83.0)
