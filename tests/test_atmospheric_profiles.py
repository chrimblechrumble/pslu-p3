...
class TestJenningsFormula:
    ...
    def test_2005_peak_near_13S(self) -> None:
        """
        At Ls=313° (2005) paper reports peak ~93.9 K near 13°S.
        """
        ...
        assert -20 <= peak_lat <= -8, (
            f"2005 peak lat expected near -13°, got {peak_lat:.1f}°"
        )
    ...
    def test_2017_peak_near_24N(self) -> None:
        """
        At Ls=90° (2017) paper reports peak ~92.8 K near 24°N.
        """
        lats = np.linspace(-90, 90, 361)
        ...
        assert 18 <= peak_lat <= 30, (
            f"2017 peak lat expected near +24°, got {peak_lat:.1f}°"
        )
    ...
    def test_equinox_equatorial_temperature(self) -> None:
        """
        At Ls=0° (2009.61 equinox) paper says equatorial T ~ 93.5 ± 0.4 K.
        """
    ...
    def test_2017_south_pole_below_90K(self) -> None:
        """
        At Ls=90° (2017) south pole cools to ~89.3 K (< 90 K).
    ...
    def test_2017_north_pole_warmer_than_south(self) -> None:
        """At Ls=90° NP has warmed ~2K relative to SP."""
    ...
    def test_huygens_landing_site_2005(self) -> None:
        """
        At Huygens landing site (10°S) in 2005 paper says T=93.9 K.
...
class TestSchinderProfiles:
    ...
    def test_T12_egress_is_coldest_at_surface(self) -> None:
        """
        T12 egress probes 52.8°S — the highest latitude of the four soundings.
        ...
        assert T_surfaces["T12_egress"] == min(T_surfaces.values()), (
            f"T12 egress (52.8°S) should be coldest: {T_surfaces}"
        )
...
class TestHASIProfile:
    ...
    def test_surface_temperature_matches_fulchignoni(self) -> None:
        """Fulchignoni et al. 2005: T_surface = 93.65 ± 0.25 K at 10°S."""
...
class TestCrossSourceConsistency:
    ...
    def test_jennings_and_schinder_agree_at_surface_31S(self) -> None:
        """
        Schinder T12 ingress (31.4°S) gives ~93.1 K at surface.
        Jennings at 2006.21 (T12 flyby date: 19 March 2006) at 31.4°S:
    ...
    def test_jennings_and_hasi_agree_at_10S_2005(self) -> None:
        """
        HASI measures 93.65 K at 10°S (Jan 2005).
        Jennings at 2005.04 (Huygens descent: 14 Jan 2005) at 10°S.
        """
