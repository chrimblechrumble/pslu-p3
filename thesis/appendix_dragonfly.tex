...
$P(H) = 0.243$ --- well below the prior mean of 0.331 and
$\sim$30 percentage points below Freeman Lacus.  On the face of it,
...
score highest ($P(H) \approx 0.541$; Freeman Lacus), and dry equatorial
...
on \titan{}, reaching $P(H) \approx 0.541$ (Freeman Lacus) and
$0.51$ (Oib Lacus).  Selk scores $P(H) = 0.243$, below the
