...
Selk crater has the highest geodiversity of any equatorial site ($f_7{=}0.659$, $7.2\times$ the global median), derived independently from SAR data.  Its lower present-epoch score ($P(H){=}0.214$) is consistent: \dragonfly{} targets past water--organic chemistry, not present-day solvent habitability (Appendix~\ref{app:dragonfly}).
