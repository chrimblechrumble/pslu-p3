...
The five epochs are: \textit{Past} ($-3.5\gya$, LHB peak), \textit{Lake Formation} ($-1.0\gya$), \textit{Present} (Cassini era), \textit{Near Future} ($+0.25\gya$), and \textit{Future} ($+5.9\gya$, red-giant ocean).  Figure~\ref{fig:temporal_trend} shows the five posterior maps and the temporal trend.  The global median rises from 0.28 at LHB to 0.41 at \textit{Present}, then reaches 0.44 at the \textit{Future} ocean epoch after a transient minimum at $+5.0\gya$.  The north polar/equatorial ratio evolves from $\sim$0.98 at LHB (undifferentiated) to $\sim$1.95 at \textit{Present} (polar lake dominance) and back to $\sim$1.02 at the \textit{Future} global ocean.
...
\subsection{\textit{Present} Epoch (Cassini Era): Lake-Margin Dominance}
...
\centering
\small
\caption{Top-10 habitable locations at the \textit{Present} Epoch (Cassini era) epoch.  $\triangle$ = lake/sea shore; $\blacksquare$ = land; $\bigstar$ = lander site.  $P(H)$ from Eq.~\ref{eq:posterior_mean}.}
...
The \textit{Past} epoch map is qualitatively distinct from the \textit{Present}.  The north
...
\centering
\small
\caption{Top-10 habitable locations at the \textit{Past} Epoch ($-3.5$\,Gya) epoch.  $\triangle$ = lake/sea shore; $\blacksquare$ = land; $\bigstar$ = lander site.  $P(H)$ from Eq.~\ref{eq:posterior_mean}.}
...
The \textit{Lake Formation} anchor at $-1.0\gya$ captures \titan{} as the polar
lake system begins to consolidate.  The prior mean $\mu_0 = 0.331$ is identical to \textit{Present}, reflecting
the same eight features and prior specification.  The spatial distribution
differs from \textit{Present} because the liquid hydrocarbon scale is only 10\%
of present, and the impact-melt proximity feature still contributes
a residual crater-site signal.  Comparing this
map to \textit{Present} reveals three changes: (1) the north polar lake margin signal
...
\subsection{\textit{Lake Formation} Epoch ($-1.0$\,Gya): Polar Lakes Establishing}
...
\centering
\small
\caption{Top-10 habitable locations at the \textit{Lake Formation} Epoch ($-1.0$\,Gya) epoch.  $\triangle$ = lake/sea shore; $\blacksquare$ = land; $\bigstar$ = lander site.  $P(H)$ from Eq.~\ref{eq:posterior_mean}.}
...
\section{\textit{Near Future} Epoch: The Stable Plateau}
\label{sec:results_nf}

The \textit{Near Future} epoch at $+0.25\gya$ confirms the expected near-identity
with the \textit{Present}.  The $\sim$2.5\% luminosity increase corresponds to a
...
rate.  The \textit{Near Future} and \textit{Present} maps are functionally equivalent
habitability states.  Figure~\ref{fig:near_future_global} confirms this
visually: the spatial correlation between the \textit{Near Future} and \textit{Present}
...
\subsection{\textit{Near Future} Epoch ($+0.25$\,Gya): Stable Plateau}
...
The \textit{Near Future} epoch ($+0.25\,\gya$) is analytically identical to \textit{Present}: the $+1.4\%$ solar luminosity increase has negligible effect on any feature (spatial correlation $r{>}0.999$).  All rankings and scores are unchanged; see Section~\ref{sec:top10_present}.



\section{\textit{Future} Epoch Habitability: The Red-Giant Ocean}
...
\subsection{\textit{Future} Epoch ($+5.9$\,Gya): Global Ocean}
...
\centering
\small
\caption{Top-10 habitable locations at the \textit{Future} Epoch ($+5.9$\,Gya) epoch.  $\triangle$ = lake/sea shore; $\blacksquare$ = land; $\bigstar$ = lander site.  $P(H)$ from Eq.~\ref{eq:posterior_mean}.}
